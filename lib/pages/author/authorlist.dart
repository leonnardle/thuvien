...
class ListAuthor extends StatelessWidget {
  const ListAuthor({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      drawer: NavBar(),
      appBar: AppBar(
        title: Text('Danh Sách Thông Tin Tác Giả'),
      ),
      body: Stack(
        children: [
          Image.asset(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    title: Text('Thông Tin ${index + 1}'),
                    subtitle: Text('Thông tin ${index + 1}'),
                    onTap: () {
